      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            {/* Logo */}
            <div className="flex flex-col items-center flex-shrink-0 cursor-pointer mr-2 lg:mr-6">
              <div className="text-amber-600 group overflow-hidden mb-1">
                 {/* Tree/Heart Mock Logo */}
                 <svg className="w-8 h-8 lg:w-10 lg:h-10 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
                   <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                 </svg>
              </div>
              <span className="font-serif font-semibold text-[8px] lg:text-[10px] tracking-widest text-amber-600">ONE LOVE HAIR</span>
            </div>

            {/* Desktop Navigation */}
            <nav className="hidden xl:flex space-x-4 lg:space-x-6">
              <a href="#" className="text-gray-800 hover:text-amber-700 font-medium text-sm lg:text-[15px] transition-colors">Home</a>
              <a href="#" className="text-gray-800 hover:text-amber-700 font-medium text-sm lg:text-[15px] transition-colors">Premium Hair Extensions</a>
              <a href="#" className="text-gray-800 hover:text-amber-700 font-medium text-sm lg:text-[15px] transition-colors">Premium Clip-In Hair Extensions</a>
              <a href="#" className="text-gray-800 hover:text-amber-700 font-medium text-sm lg:text-[15px] transition-colors">Premium Keratin Bond Extensions</a>
              <a href="#" className="text-gray-800 hover:text-amber-700 font-medium text-sm lg:text-[15px] transition-colors">More</a>
            </nav>

            {/* Icons */}
            <div className="flex items-center space-x-3 lg:space-x-6">
              <div className="hidden sm:block cursor-pointer font-medium text-sm text-gray-600 hover:text-amber-700 transition">CHF / EN v</div>
              <div className="hidden sm:flex items-center cursor-pointer hover:text-amber-700 transition text-gray-600">
                 <span className="text-sm font-medium">Search</span>
              </div>
              <div className="flex bg-black text-white rounded-full w-7 h-7 lg:w-8 lg:h-8 items-center justify-center cursor-pointer font-medium text-sm hover:bg-gray-800 transition">
                 S
              </div>
               <div className="flex items-center cursor-pointer hover:text-amber-700 transition text-gray-800">
